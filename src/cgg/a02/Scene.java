...
public class Scene
{
	...
	public Scene(int width,int height)
	{
		...
		blands.add(new Sphere(vec3(-2,2,-3),1,randomColor()));
		blands.add(new Sphere(vec3(-3,-2,-4),1,randomColor()));
		blands.add(new Sphere(vec3(2,2,-2),1,randomColor()));
		blands.add(new Sphere(vec3(2,-2,-8),1,randomColor()));
